...
* [TOTP](/docs/verify/quickstarts/totp) (authenticator apps like Authy and Google Authenticator)
* [Push and Silent Device Approval](/docs/verify/push)

For more information on Verify, see our [product page](https://www.twilio.com/en-us/trusted-activation/verify).
...
2. [Using the API](/docs/verify/api/service) (code sample on this page)
...
* `call`
* `email`, checkout the guide [Send Email Verifications with Verify and Twilio SendGrid](/docs/verify/email)
...
[Verification documentation.](/docs/verify/api/verification)
...
[VerificationCheck documentation.](/docs/verify/api/verification-check)
