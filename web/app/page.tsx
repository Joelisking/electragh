          ...
          <div className="flex justify-between items-center h-16 sm:h-20">
            <div className="flex items-center space-x-2 sm:space-x-3 flex-1 min-w-0">
              <div className="w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-br from-electra-primary to-electra-secondary rounded-xl flex items-center justify-center shadow-lg flex-shrink-0">
                <Image src="/logo.png" alt="ElectraGH" width={24} height={24} className="w-5 h-5 sm:w-6 sm:h-6" />
              </div>
            ...
            <div className="flex items-center space-x-2 sm:space-x-3 flex-shrink-0">
              ...
              {election ? (
                <Badge
                  ...
                  <span className="hidden sm:inline">Election </span>Active
                </Badge>
              ) : (
                <Badge variant="outline" className="bg-gray-50 text-gray-700 border-gray-200 text-xs px-2 py-1">
                  <Clock className="w-2 h-2 sm:w-3 sm:h-3 mr-1" />
                  <span className="hidden sm:inline">No </span>Inactive
                </Badge>
              )}
            </div>
          </div>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
        {electionLoading ? (
          <div className="text-center py-12">
            ...
            <p className="text-gray-600 text-sm sm:text-base">Loading election information...</p>
          </div>
        ) : election ? (
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
              ...
              <Card className="shadow-lg border-0 bg-white/80 backdrop-blur-sm">
                <CardHeader className="text-center pb-3 sm:pb-4">
                  ...
                  <CardTitle className="text-lg sm:text-xl">Positions</CardTitle>
                </CardHeader>
              ...
              <div>
                ...
                <div className="grid gap-4 sm:gap-6">
                  {election.positions.map((position) => (
                    <Card key={position.id} className="shadow-lg border-0 bg-white/80 backdrop-blur-sm">
                      <CardHeader className="pb-3 sm:pb-4">
                        <CardTitle className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 text-lg sm:text-xl">
                          <span className="text-center sm:text-left">{position.name}</span>
                          <Badge variant="secondary" className="self-center sm:self-auto text-xs sm:text-sm">
